...
public class MainTable extends Activity implements View.OnClickListener {
	...
	pluginHandler _pluginHandler = new pluginHandler() {
		...
		public void onError(String result) {
			...
			if (result.indexOf("Timeout") > -1) {
				...
				alert.setTitle("오류");
				alert.setMessage("서버에서 정보를 가져오지 못하였습니다.");
		...
		mHandler.post(new Runnable() {
			public void run() {
				...
				case Book05:
					...
					break;
				// case Book06 :
				// ((TextView)findViewById(R.id.btn_comm6)).setBackgroundResource(rlt);
				// break;
				// case Book07 :
				// ((TextView)findViewById(R.id.btn_comm7)).setBackgroundResource(rlt);
				// break;
				// case Book08 :
				// ((TextView)findViewById(R.id.btn_comm8)).setBackgroundResource(rlt);
				// break;
				// case Book09 :
				// ((TextView)findViewById(R.id.btn_comm9)).setBackgroundResource(rlt);
				// break;
				// case Book10 :
				// ((TextView)findViewById(R.id.btn_comm10)).setBackgroundResource(rlt);
				// break;
				// case Book11 :
				// ((TextView)findViewById(R.id.btn_comm11)).setBackgroundResource(rlt);
				// break;
				// case Book12 :
				// ((TextView)findViewById(R.id.btn_comm12)).setBackgroundResource(rlt);
				// break;
				}
			}
		});
		...
		mHandler.post(new Runnable() {
			public void run() {
				...
				case Book05:
					...
					break;
				// case Book06 :
				// ((TextView)findViewById(R.id.btn_comm6)).setVisibility(rlt);
				// break;
				// case Book07 :
				// ((TextView)findViewById(R.id.btn_comm7)).setVisibility(rlt);
				// break;
				// case Book08 :
				// ((TextView)findViewById(R.id.btn_comm8)).setVisibility(rlt);
				// break;
				// case Book09 :
				// ((TextView)findViewById(R.id.btn_comm9)).setVisibility(rlt);
				// break;
				// case Book10 :
				// ((TextView)findViewById(R.id.btn_comm10)).setVisibility(rlt);
				// break;
				// case Book11 :
				// ((TextView)findViewById(R.id.btn_comm11)).setVisibility(rlt);
				// break;
				// case Book12 :
				// ((TextView)findViewById(R.id.btn_comm12)).setVisibility(rlt);
				// break;
				}
			}
		});
	...
	private void checkReadingFlag(int idx) {
		...
		// else if(idx==5){
		// ((LinearLayout)findViewById(R.id.ll_read6)).setVisibility(View.VISIBLE);
		// }
		// else if(idx==6){
		// ((LinearLayout)findViewById(R.id.ll_read7)).setVisibility(View.VISIBLE);
		// }
		// else if(idx==7){
		// ((LinearLayout)findViewById(R.id.ll_read8)).setVisibility(View.VISIBLE);
		// }
		// else if(idx==8){
		// ((LinearLayout)findViewById(R.id.ll_read9)).setVisibility(View.VISIBLE);
		// }
		// else if(idx==9){
		// ((LinearLayout)findViewById(R.id.ll_read10)).setVisibility(View.VISIBLE);
		// }
		// else if(idx==10){
		// ((LinearLayout)findViewById(R.id.ll_read11)).setVisibility(View.VISIBLE);
		// }
		// else if(idx==11){
		// ((LinearLayout)findViewById(R.id.ll_read12)).setVisibility(View.VISIBLE);
		// }
		else if (idx == 12) {
			((LinearLayout) findViewById(R.id.ll_read2))
					.setVisibility(View.VISIBLE);
	...
	public void onClick(View view) {
		...
		// if(!mCartoonInfo.get(mBookIdx).getm2Price().equals(Common.CartoonPrice)){
		// gotoPaymentProcess(mBookIdx);
		// }
		// else {
		// loadCartoonView(mBookIdx); // 책 X권 .
